...
public class Home {
 ...
 public void openProducts(Event e)
 {
      try {
                   ...
                   Parent root = FXMLLoader.load(getClass().getResource("/superMarket/viewFXML/Products.fxml"));       
  ...
  public void openServices(Event e)
 {
      try {
                    //add you loading or delays - ;-)
                   Node node = (Node) e.getSource();
 ...
 public void openEmployee(Event e)
 {
      try {
                    //add you loading or delays - ;-)
                   Node node = (Node) e.getSource();
                   ...
                   Parent root = FXMLLoader.load(getClass().getResource("/superMarket/viewFXML/Employee.fxml"));       
                   Scene scene = new Scene(root);       
                   stage.setScene(scene);
                   stage.show();
